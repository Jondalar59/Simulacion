...
public class Creditos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INSTITUTO TECNOLÓGICO SUPERIOR DE ESCÁRCEGA");

        jLabel2.setFont(new java.awt.Font("Dialog", 1, 36)); // NOI18N
        jLabel2.setText("ISMA-4");
        ...
        jLabel3.setText("Amado Pérez Pérez");

        jLabel4.setText("Alumnos:");

        jLabel5.setText("Eliezer Chablé Jiménez");

        jLabel6.setText("Jondalar Rodríguez Díaz");

        jLabel7.setText("José Antonio Geronimo Cu");

        jLabel8.setFont(new java.awt.Font("Dialog", 1, 36)); // NOI18N
        jLabel8.setText("Simulación");
